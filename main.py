...
vocab, train_data, val_data, test_data = prepare_wikitext_dataset(device=device)
...
def train(model: nn.Module, bptt) -> None:
...
def evaluate(model: nn.Module, eval_data: Tensor, bptt) -> float:
